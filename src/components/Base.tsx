...
interface BaseProps {
  ...
  clothing: React.ComponentType<ClothingProps>
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000">
      ...
      <g mask="url(#mask)">
        ...
        <BackBody clothingColor={clothingColor} />
        <Clothing color={clothingColor} graphic={Graphic} />
        {Clothing !== Noop && <FrontBody clothingColor={clothingColor} />}
